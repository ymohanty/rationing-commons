...
\begin{figure}[htbp]
	...
	\includegraphics[width = 0.8\linewidth]{fig_pigouvian_redistribution}
	\begin{tabular*}{1.0\hsize}{c}
...
\input{tab_instrument_sets}

\renewcommand{\tabcolsep}{8pt}
\input{tab_ivpds_first_stage}

\renewcommand{\tabcolsep}{10pt}
\input{tab_ivpds_yield_on_depth.tex}

\renewcommand{\tabcolsep}{2pt}
\input{tab_ivpds_adaptation}

\renewcommand{\tabcolsep}{8pt}
\input{tab_ivpds_profit_on_depth_robustness_instruments}

\input{tab_ivpds_profit_on_depth_robustness_controls}

\input{tab_summary_nongeological_instruments}

\input{prod_func_first_stage_paper}


\input{optimal_ration}
\clearpage

\begin{figure}
	\centering
	\caption{Scatterplot of the shadow value of the ration against profit}
	\includegraphics[width=0.8\linewidth]{fig_shadow_value_profit}
	\begin{tabular*}{1.0\textwidth}{c}
...
\begin{figure}[htbp]
	...
	\subfiguretopcaptrue
	\subfigure[Daily hours of pump use]{
		\includegraphics[width=0.40\linewidth]{fig_hours_rationing_pigouvian} 
	}
	\subfigure[Water use]{
		\includegraphics[width=0.40\linewidth]{fig_water_rationing_pigouvian} 
	}
	\subfigure[Capital use]{
		\includegraphics[width=0.40\linewidth]{fig_capital_rationing_pigouvian}
	}
	\subfigure[Output]{
		\includegraphics[width=0.40\linewidth]{fig_output_rationing_pigouvian} 
	}
	\begin{tabular*}{1.0\textwidth}{c}
...
\input{tab_dynamic_parameters}

\input{tab_opp_cost_liter}
...
\begin{figure}[htbp]
	...
	\subfiguretopcaptrue
	\subfigure[Power use over time]{
		\includegraphics[width=0.47\linewidth]{fig_time_path_power.eps} 
	}
	\subfigure[Water use over time]{
		\includegraphics[width=0.47\linewidth]{fig_time_path_water.eps} 
	}
	\subfigure[Well depth over time]{
		\includegraphics[width=0.47\linewidth]{fig_time_path_depth.eps}
	}
	\begin{tabular*}{1.0\textwidth}{c}
...
\begin{figure}
	...
	\includegraphics[width=0.8\linewidth]{fig_time_path_depth_water.eps}
\end{figure}
...
\begin{figure}[htbp]
	...
	\subfiguretopcaptrue
	\subfigure[Bansur]{
		\includegraphics[width=0.40\linewidth]{fig_time_path_bansur} 
	}
	\subfigure[Dug]{
		\includegraphics[width=0.40\linewidth]{fig_time_path_dug} 
	}
	\subfigure[Hindoli]{
		\includegraphics[width=0.40\linewidth]{fig_time_path_hindoli}
	}
	\subfigure[Kotputli]{
	\includegraphics[width=0.40\linewidth]{fig_time_path_kotputli} 
	}
	\subfigure[Mundawar]{
		\includegraphics[width=0.40\linewidth]{fig_time_path_mundawar} 
	}
	\subfigure[Nainwa]{
		\includegraphics[width=0.40\linewidth]{fig_time_path_nainwa}
	}
	\begin{tabular*}{1.0\textwidth}{c}
		\multicolumn{1}{p{1.0\hsize}}{\footnotesize }\\
	\end{tabular*}
