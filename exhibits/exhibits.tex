...
\begin{figure}[htbp]
	...
	\subfiguretopcaptrue
	\subfigure[Bansur]{
		\includegraphics[width=0.47\linewidth]{fig_time_path_bansur} 
	}
	\subfigure[Dug]{
		\includegraphics[width=0.47\linewidth]{fig_time_path_dug} 
	}
	\subfigure[Hindoli]{
		\includegraphics[width=0.47\linewidth]{fig_time_path_hindoli}
	}
	\subfigure[Kotputli]{
	\includegraphics[width=0.47\linewidth]{fig_time_path_kotputli} 
	}
	\subfigure[Mundawar]{
		\includegraphics[width=0.47\linewidth]{fig_time_path_mundawar} 
	}
	\subfigure[Nainwa]{
		\includegraphics[width=0.47\linewidth]{fig_time_path_nainwa}
	}
	\begin{tabular*}{1.0\textwidth}{c}
		\multicolumn{1}{p{1.0\hsize}}{\footnotesize }\\
	\end{tabular*}
