...
\begin{figure}[htbp]
	...
	\subfigure[Power use over time]{
		\includegraphics[width=0.47\linewidth]{fig_time_path_power} 
	}
	\subfigure[Water use over time]{
		\includegraphics[width=0.47\linewidth]{fig_time_path_water} 
	}
	\subfigure[Well depth over time]{
		\includegraphics[width=0.47\linewidth]{fig_time_path_depth}
	}
	\begin{tabular*}{1.0\textwidth}{c}
...
\begin{figure}
	...
	\includegraphics[width=0.8\linewidth]{fig_time_path_depth_water}
\end{figure}
